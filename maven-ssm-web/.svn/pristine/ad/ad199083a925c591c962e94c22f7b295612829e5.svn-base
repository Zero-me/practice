...
public class testMail {
	...
	public static String recieveAddress = "18829290624@qq.com";
...
//        transport.sendMessage(msg,msg.getAllRecipients());
        ...
        //如果只想发送给指定的人，可以如下写法
//        transport.sendMessage(msg, new Address[]{new InternetAddress("18829290624@qq.com")});
     ...
     */
    public static MimeMessage getMimeMessage(Session session,String recieveAddress) throws Exception{
        //创建一封邮件的实例对象
